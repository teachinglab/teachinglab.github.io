...
- **`dashboards/shiny-server/` is kept for reference only.** It holds the app
  sources from before everything moved to Posit Connect, where all dashboards
  now live. Nothing deploys from it — the workflow that used to rsync it to the
  Shiny Server host is gone — so treat it as an archive, not as live code.
...
_Auto-generated from the Posit Connect API on 2026-08-11 12:25 EDT by `data_scripts/generate_architecture.R`. Do not edit this section by hand._
