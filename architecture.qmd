...
- Two *active* daily schedules run from sources that sit in
  `posit_automations/deprecated/`: `Coach/Facilitator Board Save` and
  `daily_percent_completion`. Either un-deprecate the sources or retire the
  schedules.
...
_Auto-generated from the Posit Connect API on 2026-08-06 01:45 EDT by `data_scripts/generate_architecture.R`. Do not edit this section by hand._

**Connect server:** https://tl-data.teachinglab.org/ — 261 content items, 30 active schedules, 4 APIs, 28 interactive apps.

### Active scheduled jobs (30)

|Job                                              |Cadence         |Run Time (ET) |Source in Repo                 |
|:------------------------------------------------|:---------------|:-------------|:------------------------------|
|Coach/Facilitator Board Save                     |Daily           |01:00         |posit_automations/deprecated   |
...
|:------------------------|:----------------|:-------------|:-------------------------------------------------|
|ongoing_report           |shiny            |2026-08-05    |dashboards/posit-connect/ongoing_report           |
|participant_feedback     |shiny            |2026-08-05    |dashboards/posit-connect/participant_feedback     |
...
|Job                                                            |Cadence |
|:--------------------------------------------------------------|:-------|
|update_coachee_selection (FY26 - deprecated, replaced by FY27) |Daily   |
