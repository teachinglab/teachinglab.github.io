...
report_galleries <- tibble::tibble(
  ...
  long_name = c(
    ...
    "Personalized Report for: Louisiana State", "Personalized Report for: Lafayette Parish",
    "Personalized Report for: Legacy Early College", "Personalized Report for: Mississippi Department of Education",
